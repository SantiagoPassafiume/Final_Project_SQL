INSERT INTO banks (id_bank, bank_name)
VALUES(1, "BBVA"),(2, "Santander"),(3, "Galicia");

INSERT INTO branches (id_branch, branch_name, id_bank)
VALUES(1, "Sorrento", 3),(2, "Paz", 2),(3, "Retiro", 1);

INSERT INTO accounts (id_account, dni, id_branch, account_name)
...
INSERT INTO transactions (id_transaction, id_account, dni, amount, `date`)
